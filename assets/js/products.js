...
console.log ("fetch");
    ...
    <div class="product-box">
      ...
      <div class="card-body">
        ...
        <div class="btn-group">
            <button type="button" class="btn btn-primary" id="btnVer_${p.id}" onclick="view(${index});">Ver más</button>
        </div>
      </div>
    </div>`;
...
window.addEventListener ("load", function() {
  let div = document.getElementById("item");addItem(div);
});
...
function view(index) {
    ...
    <strong>contacto: 3312623729 MXN<strong>`;
